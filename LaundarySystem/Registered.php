<html>
	<head>
		...
		<title>XYZ Laundary Facility</title>
	...
	<body style = "background-image:url('free-website-backgrounds1.jpg');background-repeat:no-repeat;background-size:100% 100%">
		...
		<section>
			<div class = "container">
				<h3 align = "center">Congratulation! You have Successfully Registered!<br/><br/><a href="http://www.animatedimages.org/cat-success-1574.htm"><img src="http://www.animatedimages.org/data/media/1574/animated-success-image-0010.gif" border="0" alt="animated-success-image-0010"/></a></h3>
				<div class = "row"><br/>				
					<div class = "col-md-4"></div>
					<div class = "col-md-4" align = "center">
						<div class = "btn-group">
							<a href = "ClientLogin.php" ><button class = "btn btn-success btn-md w3-card-4">LogIn</button></a>
						</div>
					</div>
					<div class = "col-md-4"></div>
				</div>
